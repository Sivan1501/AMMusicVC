...
from AMMusic.utils import help_pannel
from AMMusic.utils.database import get_lang, is_commanddelete_on
from AMMusic.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from AMMusic.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgEAAx0CbcjZvwACDkRkth_pxAkk8zfe86xUJ3u9y-M9fgACawIAApacYUQ-M-G4KpSBdC8E")
