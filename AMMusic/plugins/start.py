...
from AMMusic.misc import SUDOERS, _boot_
from AMMusic.plugins.playlist import del_plist_msg
from AMMusic.plugins.sudoers import sudoers_list
from AMMusic.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from AMMusic.utils.decorators.language import LanguageStart
from AMMusic.utils.formatters import get_readable_time
from AMMusic.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgEAAx0CbcjZvwACDkRkth_pxAkk8zfe86xUJ3u9y-M9fgACawIAApacYUQ-M-G4KpSBdC8E")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/AMBOTYT) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/AMBOTYT"
                        ),
                    ],
                ]
            )
