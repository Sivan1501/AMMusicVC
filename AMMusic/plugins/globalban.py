...
from AMMusic.utils import get_readable_time
from AMMusic.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
                                       remove_banned_user)
from AMMusic.utils.decorators.language import language
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgQAAx0CbcjZvwACDkdktiCN7TL0NLaTt6kPcu73LBVLPQACjw8AApuTaVDPny1vQC6GCC8E")
